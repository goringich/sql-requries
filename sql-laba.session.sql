...
-- Создание таблицы ОТДЕЛЕНИЕ__КООП
...
-- Создание таблицы ЗАКУПКИ с внешними ключами
...
-- Вставка данных в таблицу ОТДЕЛЕНИЕ__КООП
...
-- Вставка данных в таблицу ПОТРЕБИТЕЛЬ
...
-- Вставка данных в таблицу ЗАКУПКИ
INSERT INTO "ЗАКУПКИ" ("НОМЕР_ДОГОВОРА", "ДАТА", "ОТДЕЛЕНИЕ__КООП", "ПОТРЕБИТЕЛЬ", "ТОВАР", "КОЛ_ВО", "ИТОГО_RUB")
VALUES 
(29036, '2024-01-15', '005', '001', '007', 10, 80000),
(29037, '2024-01-20', '002', '002', '006', 1, 7500),
(29038, '2024-01-25', '004', '002', '004', 2, 4400);
